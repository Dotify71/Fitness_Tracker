...
I built this because I wanted a simple, all-in-one place to plan my workouts and track my water intake without needing to sign up for a fishey commercial app or pay a subscription. Plus, everything you log is saved right in your browser using `localStorage`, which means it's super fast and your data stays entirely on your local machine.

## Features

1. **Dashboard:** Gives you a quick look at today's stats, a recovery index, and your daily intensity score based on what you actually completed.
...
6. **Tools:** Built-in BMI and BMR calculators, plus a small tool to suggest calorie targets depending on if you want to cut or bulk in your physique.
